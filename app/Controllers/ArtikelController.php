...
class ArtikelController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('back-end/dashboardView/artikel/adminArtikel',$data);
    ...
    public function tambah_data(){
        ...
        return view('back-end/dashboardView/artikel/create', $data);
    }
    ...
    public function edit_artikel($id) {
		...
		return view('back-end/dashboardView/artikel/editArtikel', $data);
    }
